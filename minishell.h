...
// heredocs2
int	child_prepare
(char **heredoc_name, char *input, char *start, t_vars *to_free);
void	just_clear_history_and_free(t_vars *to_free);
void	prepare_and_exec_hdoc
(char *heredoc_name, t_env **env, int pid, int pipes[]);
...
int		pre_execution
(char **commands, t_vars *command, int *heredocs, int actual);

// multiple_commands1
int		close_heredocs_except_in_index(int *heredocs, int index_to_save);
int		free_commands_and_heredocs
(char **commands, int *heredocs, int exit_status);
...
// one_command
int	execute_one_command
(char **command, t_env **env, int exit_s, int fd_heredoc);
...
// fds
int		get_fds
(char **splitted, t_env **env, t_redirects *redir, int fd_heredoc);
...
int		ft_help
(char **command, t_redirects redir, t_env **env, int exit_status);
int		ft_echo
(char **command, t_redirects redir, t_env **env, int exit_status);
int 	ft_pwd
(char **command, t_redirects redir, t_env **env, int exit_status);
...
int		print_arg_error
(char *command, char *arg, char *error, int exit_status);
